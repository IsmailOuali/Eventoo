            ...
            <div class="ticket" aria-hidden="true">
              <div class="ticket__header">
                <div class="ticket__co">
                  ...
                  <span class="u-upper ticket__co-subname">Bring Events to You
                  </span>
                </div>
              </div>
              <div class="ticket__body">
                <p class="ticket__route">{{ $event->title }}</p>
                <p class="ticket__description">{{ $event->description }}</p>
                <div class="ticket__timing">
                  <p>
                    <span class="u-upper ticket__small-label">Date</span>
                    <span class="ticket__detail">{{ $event->date }}</span>
                  </p>

                  <p>
                    <span class="u-upper ticket__small-label">Category</span>
                    <span class="ticket__detail">{{ $event->category->name }}</span>
                  </p>
                </div>
                <p class="u-upper ticket__admit">{{ $client->name }}</p>
