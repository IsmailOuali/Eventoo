                        ...
                        <td class="px-4 py-3"> 
                            <div class="flex">
                                <form method="post" action="{{route('admin.detroyCategory', ['category'=>$category])}}">
                                  @csrf
                                  @method('DELETE')
                                    <button type="submit" class="flex-1 underline p-1 mr-1 rounded-full bg-red-500 text-white cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
                                        Delete
                                    </button>
                                </form>
                                <a href="{{ route('admin.editCategory', ['category'=>$category]) }}" class="flex-1 p-1 underline text-white cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Update">Edit
                                </a>
                            </div>
                        </td>
