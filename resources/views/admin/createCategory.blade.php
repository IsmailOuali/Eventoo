                ...
                <form method="post" action="{{ route('admin.storeCategory') }}">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      <div>         
                        ...
                        <input id="title" name="name" type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Party" />
                      </div>
