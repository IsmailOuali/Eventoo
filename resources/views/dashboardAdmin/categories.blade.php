...
=        <div class=" flex flex-wrap">
            ...
            <div class="flex-1 p-4 w-full">
                ...
                <div class="relative w-1/4 min-w-[200px] h-10 pt-4">
                    <form action="{{route('add_cat.store')}}" method="post">
                      @csrf
                      ...
                      @method('POST')
                        ...
                        <button type="submit" class="mt-4 px-3 py-1 shadow-lg shadow-gray-500/50 bg-black text-white rounded-lg text-[15px] cursor-pointer active:scale-[.97]">
			            Ajouter</button>
                    </form>
                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    <div class="overflow-hidden">
                      <table
                        class="rounded bg-gray-200 min-w-full text-black text-left text-sm font-light text-surface">
                        <thead
                        ...
                        <tbody>
                          ...
                          <tr class="border-b border-neutral-200 transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-white/10 dark:hover:bg-neutral-600">
                              ...
                              <td class="whitespace-nowrap px-6 py-4">
                                  <form action="{{ route('add_cat.destroy', $category->id) }}" method="post">
                                      @csrf
                                      @method('DELETE')
